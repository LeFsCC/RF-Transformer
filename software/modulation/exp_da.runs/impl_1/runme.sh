...
HD_PWD='F:/TL/ALter/CodeForPost/FPGAXilinxCode/verilog_prj/test_xulie7_7/exp_da.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log exp_da.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source exp_da.tcl -notrace
